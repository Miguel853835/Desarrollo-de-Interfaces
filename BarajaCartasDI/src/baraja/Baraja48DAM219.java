...
/**
 * Clase que representa una baraja de cartas españolas de 48 cartas.
 ...
 * @since 11/12/2023
 */
public class Baraja48DAM219 {
    private final ArrayList<Carta48DAM219> cartas;
     ...
     */
    public static final int NUM_CARTAS_MIN = 48;

    /**
     * Número máximo de cartas en la baraja.
     */
    public static final int NUM_CARTAS_MAX = 48;

    /**
     * Constructor de la clase. Crea, baraja y posiciona en la primera carta.
     */
    public Baraja48DAM219() {
    ...
    private void crearBaraja() {
        for (String palo : PALOS) {
            for (int i = 1; i <= LIMITE_CARTA_PALO; i++) {
                ...
                cartas.add(new Carta48DAM219(valor, palo));
            }
        }
    }
     ...
     */
    public Carta48DAM219 siguienteCarta() {
     ...
     * @return ArrayList de Carta48DAM219 con las cartas obtenidas.
     */
    public ArrayList<Carta48DAM219> darCartas(int numCartas) {
        if (cartasDisponibles() >= numCartas) {
            ArrayList<Carta48DAM219> cartasSacadas = new ArrayList<>();
     ...
     *
     * @param cartasSacadas ArrayList de Carta48DAM219 con las cartas en el montón.
     */
    public void cartasMonton(ArrayList<Carta48DAM219> cartasSacadas) {
        if (cartasSacadas != null && !cartasSacadas.isEmpty()) {
            System.out.println("Cartas en el montón:");
            for (Carta48DAM219 carta : cartasSacadas) {
